...
chord
```
#### One of the more significant findings from this landfire analysis is that the riparian habitat has been heavily changed into differing habitats such as conifer and hardwood.
